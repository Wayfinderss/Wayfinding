...
from app.core.paths import VALHALLA_DATA, TILES_DIR
from app.states.config_state import ValhallaConfigState
from typing import Optional
from app.core.paths import TRANSIT_DIR, TRANSIT_FEEDS_DIR, ELEVATION_DIR

@register("config_builder")
class ValhallaConfigBuilder(TestService):
    service_name = "config_builder"
    @staticmethod
    def build() -> ValhallaConfigState:
        config = {
            "mjolnir": {
                ...
                "tile_extract": str(TILES_DIR / "tiles.tar"),
                "traffic_extract": str(TILES_DIR / "traffic.tar"),
        ...
        return ValhallaConfigState(config)

    def run(self) -> ValhallaConfigState:
        return ValhallaConfigBuilder.build()
